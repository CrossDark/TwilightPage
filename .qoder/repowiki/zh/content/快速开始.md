...
- [twilightpage.typ](file://src/twilightpage.typ)
</cite>

## 更新摘要
**所做更改**
- 更新模板名称从 "tufted" 到 "twilightpage"
- 更新所有相关的命令示例和文件路径引用
- 更新 README.md 中的中文翻译内容
- 更新 Makefile 中的链接目标和包名
- 更新 typst.toml 中的包元数据
- 更新源代码中的导入路径和样式引用
...
**更新** 模板现已重命名为 "twilightpage"，提供更好的性能和更丰富的功能集。
...
- [Makefile（模板）:1-35](file://template/Makefile#L1-L35)
...
1. 初始化模板
   ...
   - 命令示例：typst init @preview/twilightpage:0.1.1
...
**更新** 命令中的模板名称已从 "tufted" 更新为 "twilightpage"
...
- [Makefile（模板）:31-35](file://template/Makefile#L31-L35)

## 项目结构详解
- src/ 核心源码
  - layout.typ：定义边注与全宽内容等布局组件
  - twilightpage.typ：主模板入口，负责样式和页面结构
- template/ 模板
...
- [twilightpage.typ:1-64](file://src/twilightpage.typ#L1-L64)
...
- 自定义样式
  ...
  - 主题样式由 template/assets/tufted.css 提供（基于 Tufte CSS）
- 页面布局
  - 使用 src/layout.typ 中的组件（如边注、全宽内容）增强页面表现
  - 主模板入口在 src/twilightpage.typ

**更新** 样式文件仍使用 "tufted.css" 名称，但内容已针对 TwilightPage 进行优化
...
- [twilightpage.typ:17-63](file://src/twilightpage.typ#L17-L63)
...
**更新** TwilightPage 模板现已稳定发布 0.1.1 版本，提供更好的性能和更丰富的功能集。